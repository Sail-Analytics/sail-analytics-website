...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://sail-analytics.com/" },
      { property: "og:image", content: "https://sail-analytics.com/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://sail-analytics.com/og-image.png" },
    ],
    links: [{ rel: "canonical", href: "https://sail-analytics.com/" }],
  }),
  component: Index,
});
